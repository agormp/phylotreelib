...
## Unreleased (on GitHub but not yet on PyPi)

#### Changed
- Changed organisation of test files: now in dedicted sub-folders of tests/
...
#### Fixed
- Now consistently uses space, not mixture of space and tabs, to indent elements in NEXUS format output
